...
const {Message, StringSession, Image, Video} = require('./Riazgregory/');
...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('sᴇᴍᴘᴀɪ ɪs ' + config.WORKTYPE + ' 𝚗𝚘𝚠 💞'));
            await conn.sendMessage(conn.user.jid, "sᴇᴍᴘᴀɪ ᴡᴏʀᴋɪɴɢ", MessageType.text);
        ...
        var ansk = 'https://gist.github.com/nexusNw/6ddc45517f0bffd3b042db2ab42ac94d/raw'
        ...
        while (getGMTh == 7 && getGMTm == 01) {
            ...
            return await conn.sendMessage(conn.user.jid, '*[ DAILY ANNOUNCEMENTS NEXUSNW ]*\n\n' + announce, MessageType.text);
        }
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '__𝗥𝗶𝗮𝘇-𝘀𝗲𝗺𝗽𝗮𝗶_☠☠_[error] ' +
                                    '\n\n*☠︎︎ ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
