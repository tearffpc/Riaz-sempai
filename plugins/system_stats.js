...
if (Config.WORKTYPE == 'private') {
    ...
    Riaz.addCommand({pattern: 'alive', fromMe: true, desc: Lang.ALIVE_DESC}, (async (message, match) => {
    ...
    Riaz.addCommand({pattern: 'sysd', fromMe: true, desc: Lang.SYSD_DESC}, (async (message, match) => {
   ...
   Riaz.addCommand({pattern: 'alive', fromMe: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
...
var i = Math.floor(31*Math.random())
    ...
    if (Config.ALIVEMSG.includes('{pp}')) {
        ...
        a_plk[0] = "https://i.imgur.com/iDrLMal.jpeg";
        a_plk[1] = "https://i.imgur.com/n37nF31.jpeg";
        ...
        a_plk[5] = "https://i.imgur.com/hlwSx8N.jpeg";
...
//codded by afnanplk
    ...
    Riaz.addCommand({pattern: 'sysd', fromMe: false, desc: Lang.SYSD_DESC}, (async (message, match) => {
    ...
    Riaz.addCommand({pattern: 'psysd', fromMe: true, desc: Lang.SYSD_DESC, dontAddCommandList: true }, (async (message, match) => {
