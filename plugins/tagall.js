...
Riaz.addCommand({pattern: 'tag ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.TAGALL_DESC }, (async (message, match) => {
...
async function checkImAdmin(message, user = message.client.user.jid) {
    ...
    Riaz.addCommand({pattern: 'tag ?(.*)', fromMe: false, dontAddCommandList: true, desc: Lang.TAGALL_DESC }, (async (message, match) => {
    ...
    if (!message.reply_message) {
     ...
     Riaz.addCommand({pattern: 'report ?(.*)', fromMe: false, desc: 'to report someone'}, (async (message, match) => {
        if (match[1] == '') {
