...
if (Config.WORKTYPE == 'private') {
    ...
    Riaz.addCommand({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
    ...
    Riaz.addCommand({pattern: 'pink', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
await message.sendMessage(r_text[i]);
    ...
    Riaz.addCommand({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    Riaz.addCommand({pattern: 'alive', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
