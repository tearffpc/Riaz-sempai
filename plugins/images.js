...
if (Config.WORKTYPE == 'private') {
    ...
    Riaz.addCommand({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    Riaz.addCommand({pattern: 'anime', fromMe: false, desc:'random anime image '}, (async (message, match) => {
